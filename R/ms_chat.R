...
ms_chat <- R6::R6Class(
    ...
    public = list(
                                ...
                                mentions = NULL)
        {
            ...
            call_body <-
                build_chatmessage_body(self, body, content_type, attachments, inline, mentions)
            res <-
                self$do_operation("messages", body = call_body, http_verb = "POST")
                              ...
                              id = NULL)
        {
            ...
            else
            {
                filter <- if (!is.null(name))
                    ...
                    sprintf("microsoft.graph.aadUserConversationMember/email eq '%s'",
                            email)
